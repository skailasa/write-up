...
We see that the Gaussian function in a Schwartz space is an eigen-funcion of the Fourier transform. Let's show this in the one-dimensional case, where $\phi(x) = e^{-\frac{x^2}{2}}$, clearly this satisfies the property that $\partial_x \phi = -x \phi$
